...
<style>
  :root{{--bg:#f2f5f7; --card:#fff; --ink:#1c2733; --muted:#5b6b7a; --teal:#0e7490; --rose:#c2456b; --amber:#d97706; --navy:#1e3a5f; --radius:16px; --shadow:0 4px 14px rgba(30,42,56,.08);}}
  *{{box-sizing:border-box; margin:0; padding:0;}}
  body{{background:var(--bg); color:var(--ink); font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif; line-height:1.6; padding:1.6rem 1rem 3rem;}}
  ...
  h1{{font-size:clamp(1.9rem,6vw,2.8rem); font-weight:800; text-transform:uppercase; letter-spacing:-.02em; margin:.6rem 0 .2rem;}}
  h1 .bloom{{color:var(--rose);}}
  ...
  ul{{list-style:none;}}
  li a{{display:flex; justify-content:space-between; align-items:center; padding:.75rem 1rem; margin-bottom:.55rem; border-radius:12px; background:#f6f9fa; border:1px solid #e3e9ee; color:var(--ink); text-decoration:none; font-weight:600; font-size:.95rem;}}
  li a:hover{{background:#eaf3f6;}}
